...
from rrquant.cpp.core import KDataDriver, DataDriverFactory
from rrquant import KRecord, Query, Datetime, Parameter, KRecordList
...
#rq_param = sm.get_hikyuu_parameter()

#切换K线数据驱动，重新初始化
#sm.init(base_param, block_param, tdx_param, preload_param, rq_param)
